...
void bsr_spmm_multicore_sparse_mcast(
   ...
   std::deque<uint32_t> folded_bsr_matrix_indices;
    ...
    tt::tt_metal::distributed::ReplicatedBufferConfig buffer_config_dst{.size = dram_buffer_dst_row_size};
    ...
    */
    ...
    // EnqueueWriteBuffers
    tt::tt_metal::distributed::EnqueueWriteMeshBuffer(cq, src0_dram_buffer, a.data.data(), true);
    tt::tt_metal::distributed::EnqueueWriteMeshBuffer(cq, src1_dram_buffer, b.data.data(), true);
    tt::tt_metal::distributed::EnqueueWriteMeshBuffer(cq, column_indices_dram_buffer, a.indices.data(), true);
    tt::tt_metal::distributed::EnqueueWriteMeshBuffer(cq, indptr_dram_buffer, a.indptr.data(), true);
